...
export default function MaterialesItemPage() {
  ...
  const handleCreateLista = async () => {
    ...
    try {
      ...
      // Crear el material usando la API de admin (que también crea la oferta automáticamente)
      const materialData = {
        nombre: createListaForm.nombre, // Nombre completamente limpio sin indicadores
  ...
  const handleEditOferta = (oferta: any) => {
    ...
    let validImageUrl = isBlobUrl ? '' : (oferta.imagenUrl || '');
                        ...
                        <div className="flex-shrink-0">
                          <div className="w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center overflow-hidden">
                            {(() => {
                              ...
                              if (oferta.imagenUrl && !oferta.imagenUrl.startsWith('blob:')) {
                                  ...
                                  <img
                                    ...
                                    onError={(e) => {
                                      ...
                                      if (parent && !parent.querySelector('.error-text')) {
                                        ...
                                        errorDiv.innerHTML = '<span class="text-xs text-gray-500">📷</span>';
